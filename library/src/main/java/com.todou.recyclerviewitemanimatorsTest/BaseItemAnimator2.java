 ...
 */
public abstract class BaseItemAnimator2 extends RecyclerView.ItemAnimator {
    ...
    public BaseItemAnimator2(RecyclerView recyclerView){
    ...
    protected abstract void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY);
